...
# from dag_transform.customer_product_transactions_2db.default_config import default_config
...
# }
# config = Variable.get("customer_product_transactions_2db", default_var=default_config)

# dag = DAG(
#     'customer_product_transactions_2db',
